    ...
    <div className="feed-comments-container">
        ...
        <div className="feed-comments-post-preview">
          <div className="feed-comments-post-header">
            ...
            <div className="feed-comments-post-info">
              <p className="feed-comments-post-author">
                {postState.author.name}
              </p>
              <p className="feed-comments-post-timestamp">
                {postState.timestamp}
              </p>
            </div>
          </div>
          ...
          <div className="feed-post-tags">
            ...
            {typeof postState.editCount === "number" &&
              postState.editCount > 0 && (
                <span
                  className="feed-post-tag"
                  style={{ background: "#f3f3f3", color: "#666" }}
                >
                  Edited {postState.editCount}{" "}
                  {postState.editCount === 1 ? "time" : "times"}
                </span>
              )}
            ...
            {["Marketplace", "Roommate Request", "Lost and Found"].includes(
              ...
              <span
                className="feed-post-tag"
                style={{
                  background: postState.resolved ? "#c6f6d5" : "#fed7d7",
                  color: postState.resolved ? "#276749" : "#c53030",
                  marginLeft: "6px",
                }}
              >
      ...
      <div className="feed-comments-section">
        <div className="feed-comments-header-row">
          <h2 className="feed-comments-section-title" style={{ margin: 0 }}>
          ...
          {getSortedComments().map((comment) => (
            ...
            >
              ...
              <div className="feed-comment-content">
                  ...
                  {(comment.author.userId === currentUserId || isAdmin) && (
                    <div ref={openMenuId === comment.id ? menuRef : null}>
                      ...
                      {openMenuId === comment.id && (
                        <div
                          className="feed-post-menu-dropdown"
                          style={{ right: 0, left: "auto", top: "36px" }}
                        >
                ...
                {typeof comment.editCount === "number" &&
                  comment.editCount > 0 && (
                    <span className="feed-comment-edit-tag">
                      Edited {comment.editCount}{" "}
                      {comment.editCount === 1 ? "time" : "times"}
                    </span>
                  )}
